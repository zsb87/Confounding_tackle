"""
With only features from whole piece, with limitation that len > 36 points that is 1.8 seconds
...
for SUBJ in SUBJS:
    ...
    for ACTIVITY in ACTIVITIES:
        ...
        for act in activity_dict[ACTIVITY]:
            ...
            out_file = os.path.join(SAMPLE_FEAT_FOLDER, act, act+'_groundtruthsegmentation_all_features_lengthover1d8.csv')
